      ...
      {data?.data.length >
        0 ? (
          <>
                    ...
                    <TableCell className="text-blue-700 text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem><Link to={`/view-meeting/${meeting.id}`}>View details</Link></DropdownMenuItem>
                          <DropdownMenuItem><Link to={`/edit-meeting/${meeting.id}`}>Edit meeting</Link></DropdownMenuItem>
                          <DropdownMenuSeparator />
                          <DropdownMenuItem
            ...
            <h1 className="text-center text-lg font-medium text-primary">You don't have any meeting available</h1>
        )}
    </>
  );
}
